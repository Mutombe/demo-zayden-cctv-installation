...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-red-600' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      <div className="absolute top-[15%] left-0 w-[2px] h-32 sm:h-48 bg-gradient-to-b from-transparent via-red-600 to-transparent z-20" />
      ...
      >
        <motion.div
          ...
          className="w-16 h-[2px] bg-gradient-to-r from-red-600 to-red-500/50 mb-6 origin-left"
        />
        ...
        <motion.p
          ...
          className="text-red-500 text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] mb-8"
        ...
        <div className="overflow-hidden">
          {['SEE', 'EVERYTHING', 'MISS NOTHING.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  line === 'EVERYTHING'
                    ? 'bg-gradient-to-r from-red-600 via-red-500 to-red-400 bg-clip-text text-transparent italic'
                    : 'text-white'
                }`}
                style={{
                  fontSize: 'clamp(2.2rem, 7vw, 4.5rem)',
                  fontWeight: line === 'EVERYTHING' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-red-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-red-600 hover:shadow-xl hover:shadow-red-600/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
          ...
          <Link
            to="/projects"
            className="group inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:border-red-600/50 hover:text-red-500 hover:bg-white/5"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaSecondary}
          </Link>
      ...
      >
        ...
        >
          <ArrowDown size={14} className="text-red-600/40" />
        </motion.div>
      </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Zayden CCTV Installation &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['CCTV SYSTEMS', 'ALARM SYSTEMS', 'ACCESS CONTROL', 'ELECTRIC FENCING', 'INTERCOMS', 'CONSULTING'];
  const repeated = [...items, ...items, ...items, ...items];

  return (
    <section className="bg-navy-950 border-y border-red-600/10 py-5 sm:py-6 overflow-hidden">
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-red-600/80 font-heading text-lg sm:text-2xl italic tracking-wider">
              {item}
            </span>
            <span className="text-red-600/20 text-sm">&diams;</span>
          </span>
        ))}
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-red-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Do</p>
            ...
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-red-600 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-red-600/15 font-heading text-6xl sm:text-7xl italic leading-none">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  <div className="absolute top-5 left-5 z-10 w-10 h-10 border border-red-600/30 flex items-center justify-center bg-navy-950/60 backdrop-blur-sm group-hover:bg-red-600/20 group-hover:border-red-600/60 transition-all duration-500">
                    <IconComp size={18} weight="light" className="text-red-600" />
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-10">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-red-600 group-hover:translate-x-1 transition-transform duration-300">
                      <span className="text-xs uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>Explore</span>
                      <ArrowRight size={14} />
                    </div>
                  </div>

                  <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-red-600 to-red-500 z-10" />
                </Link>
              </motion.div>
            );
          })}
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[2px] bg-red-600 mb-6" />
            <p className="text-red-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Selected Works</p>
          ...
          {projects.items.map((project, i) => (
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-red-600/40 transition-colors duration-500 z-10" />
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-red-600/90 text-white text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-48 h-48 bg-red-600/5 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-48 h-48 bg-red-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-red-600 leading-none italic"
              ...
              {i < stats.length - 1 && (
                <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 h-16 w-[1px] bg-gradient-to-b from-transparent via-red-600/15 to-transparent" />
              )}
            </motion.div>
          ))}
        </div>
    ...
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="w-12 h-[2px] bg-red-600 mb-6" />
            <p className="text-red-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Story</p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">2019</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">350+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Served</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">5+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Zayden CCTV Installation team"
                  className="w-full aspect-square object-cover object-center"
                  loading="lazy"
                />
              </div>
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-red-600 text-white p-5 sm:p-7 shadow-2xl">
                <div className="text-center">
                  <div className="font-heading text-xs uppercase tracking-[0.2em] leading-none" style={{ fontFamily: 'var(--font-sans)' }}>Est.</div>
                  <div className="font-heading text-3xl sm:text-4xl italic leading-none mt-1">2019</div>
                </div>
              </div>
              <div className="absolute -top-3 -left-3 w-16 h-16 border-t-2 border-l-2 border-red-600/30" />
            </div>
          </motion.div>
        </div>
      </div>
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Latest Technology', desc: 'We install only current-generation equipment from leading security brands.' },
    { title: 'Custom Design', desc: 'Every system designed around your specific property and risk profile.' },
    { title: 'Professional Installation', desc: 'Clean, tidy installations by certified technicians who take pride in their work.' },
    { title: 'Ongoing Support', desc: 'Maintenance plans, remote support, and rapid on-site service when you need it.' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <div className="absolute -top-3 -left-3 w-20 h-20 border-t-2 border-l-2 border-red-600/40" />
            <div className="absolute -bottom-3 -right-3 w-20 h-20 border-b-2 border-r-2 border-red-600/40" />
          </motion.div>
          ...
          >
            <div className="w-12 h-[2px] bg-red-600 mb-6" />
            <p className="text-red-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Difference</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-red-600">Zayden</span>
            </h2>
              ...
              {points.map((point, i) => (
                ...
                >
                  <div className="shrink-0 mt-1">
                    <div className="w-8 h-8 border border-red-600/30 flex items-center justify-center bg-red-600/5">
                      <CheckCircle size={16} weight="fill" className="text-red-600" />
                    </div>
                  </div>
                  <div>
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          <Quotes size={48} weight="fill" className="text-red-600/15 mx-auto mb-8" />
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full object-cover object-center border-2 border-red-600/30" loading="lazy" />
                )}
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} size={12} weight="fill" className="text-red-600" />
                  ))}
                </div>
              </div>
            </motion.div>
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button onClick={prev} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-red-600 hover:border-red-600/30 transition-colors duration-300" aria-label="Previous testimonial">
              <CaretLeft size={16} />
            </button>
            <div className="flex gap-2">
              {homeTestimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)} className={`h-[2px] transition-all duration-500 ${i === active ? 'w-10 bg-red-600' : 'w-3 bg-white/10 hover:bg-white/25'}`} aria-label={`Go to testimonial ${i + 1}`} />
              ))}
            </div>
            <button onClick={next} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-red-600 hover:border-red-600/30 transition-colors duration-300" aria-label="Next testimonial">
              <CaretRight size={16} />
            </button>
          </div>
        </motion.div>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="Zayden CCTV Installation" className="w-full h-[130%] object-cover object-center" loading="lazy" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 1 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact" className="group relative inline-flex items-center gap-3 bg-red-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-red-600 hover:shadow-xl hover:shadow-red-600/25" style={{ fontFamily: 'var(--font-sans)' }}>
              {homeCta.ctaPrimary}
              <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
            </Link>
            <a href={`https://wa.me/${business.whatsappNumber}?text=${encodeURIComponent(homeCta.whatsappText)}`} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 border border-red-600/40 text-red-500 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-red-600/10 hover:border-red-600/60" style={{ fontFamily: 'var(--font-sans)' }}>
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            <a href={`tel:${business.phoneRaw}`} className="flex items-center gap-2 hover:text-red-600 transition-colors">
              <Phone size={14} /> {business.phone}
            </a>
            <span className="hidden sm:inline text-white/10">|</span>
            <a href={`mailto:${business.email}`} className="hover:text-red-600 transition-colors">{business.email}</a>
            <span className="hidden sm:inline text-white/10">|</span>
